            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        {{-- Anda bisa ganti logo di sini --}}
                        <svg class="block h-9 w-auto fill-current text-gray-800" viewBox="0 0 20 20">
                            <path d="M10 2a8 8 0 100 16 8 8 0 000-16zM9 10a1 1 0 112 0 1 1 0 01-2 0z" />
